...
public class UpdateCompanyDtoDataAttribute_Invalid : DataAttribute
{
    public override IEnumerable<object[]> GetData(MethodInfo testMethod)
    {
        ...
        yield return new object[] { CompanyRepresentantMissingProp() };
        yield return new object[] { CompanyAddressMissingProp() };
    }
    ...
    public static UpdateCompanyDto CompanyRepresentantMissingProp() =>
        new() { Id = 1, Representant = UpdatePersonDtoDataAttribute_Invalid.PersonWithoutId() };

    public static UpdateCompanyDto CompanyAddressMissingProp() =>
        new() { Id = 1, Address = UpdateAddressDtoDataAttribute_Invalid.AddressEmptyProp() };
}
